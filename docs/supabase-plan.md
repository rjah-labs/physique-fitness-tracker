...
- `goals`: structured bodyweight, measurement, strength, performance and consistency goals, including editable priority, fixed starting point, target, exercise link, deadline and status. Each goal remains owned by one authenticated user through RLS.
