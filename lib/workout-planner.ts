...
export const planner={
 ...
 async plan(date:string,cardId:string|null,weeks=1):Promise<string>{const {data,error}=await supabase.rpc('plan_workout_day',{p_date:date,p_card:cardId,p_weeks:weeks});if(error)throw error;return data},
